...
export const LoginPage = () => {
  ...
  const { startLogin, messageError, LimpiarMessageError } = useUserSlice()
  ...
  return (
    <>
      ...
      {
        (messageError || errorModal) && (<ErrorModal error={messageError} errorFront={errorModal} seterrorModal={(value) => closeModal(value)} />)
      }
    </>
  )
}
