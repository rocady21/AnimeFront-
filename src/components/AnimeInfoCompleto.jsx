          ...
          (
            <div className="w-full h-full box-border flex flex-col box-border box-content relative ">
              <div className="portada w-full flex flex-row bg-black h-[300px] absolute ">
                <p className="text-white self-end ml-[30%] mb-[10px] italic text-[40px]  ">{results.name}</p>
                <div className="info  w-[300px] h-[750px] mt-[100px] ml-[6%] flex flex-col items-center absolute ">
                  <div className="foto w-full h-[800px] bg-white p-[5px] rounded-[20px]">
